//! Type definitions for the Lightcone Pinocchio SDK.
//!
...
impl TryFrom<u8> for MarketStatus {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(crate::error::SdkError::InvalidMarketStatus(value)),
        }
    }
}
...
impl TryFrom<u8> for OrderSide {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            0 => Ok(OrderSide::Bid),
            1 => Ok(OrderSide::Ask),
            _ => Err(crate::error::SdkError::InvalidSide(value)),
        }
    }
}
...
pub struct MatchOrdersMultiParams {
    ...
    pub quote_mint: Pubkey,
    /// Taker order (signed)
    pub taker_order: crate::orders::FullOrder,
    /// Maker orders (signed)
    pub maker_orders: Vec<crate::orders::FullOrder>,
