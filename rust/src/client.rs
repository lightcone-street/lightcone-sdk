...
use crate::accounts::{Exchange, Market, OrderStatus, Position, UserNonce};
use crate::constants::PROGRAM_ID;
use crate::ed25519::{create_cross_ref_ed25519_instructions, create_order_verify_instruction};
use crate::error::{SdkError, SdkResult};
use crate::instructions::*;
use crate::orders::{derive_condition_id, FullOrder};
use crate::pda::{
...
impl LightconePinocchioClient {
    ...
    pub async fn get_next_nonce(&self, user: &Pubkey) -> SdkResult<u64> {
        self.get_user_nonce(user).await
    }
